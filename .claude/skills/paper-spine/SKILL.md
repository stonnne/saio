---
name: paper-spine
description: Use when the user wants to write, rewrite, or build a paper or report (journal, conference, report, review, competition) end to end through a contribution-first, reviewer-aware workflow, then output LaTeX, PDF, or Word.
---
